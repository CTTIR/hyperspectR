...
Displays a single tissue index as a pseudocolor spatial map with color
scales selected for research visualization.
...
- range:
  ...
  Numeric vector of length 2. Display range. Default `NULL` (data
  range).
