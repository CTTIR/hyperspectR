...
Source:
[`DESCRIPTION`](https://github.com/cttir/hyperspectR/blob/main/DESCRIPTION)

Heller R, Forstmeier V (2026). *hyperspectR: Hyperspectral Imaging
Analysis for Biomedical Applications*. R package version 0.2.0.9000,
